...
const CATALOG = {
  ...
  'navigator':        { file: 'navigator.html',        label: 'Agreement Manager',         keywords: ['repository','agreements','library','navigator','contract','filter','document list','insights','metadata'] },
  ...
  'maestro':          { file: 'maestro.html',          label: 'Workflow Builder',           keywords: ['workflow','orchestration','maestro','steps','automation','no-code','routing','flow builder'] },
